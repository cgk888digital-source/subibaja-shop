...
import { ChevronLeft, Ruler, ShoppingBag, MessageCircle, Sparkles, CheckCircle2, ArrowRight, Info } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-['Lato',sans-serif] pb-24">
      ...
      <main className="max-w-md md:max-w-4xl mx-auto px-4 pt-6 space-y-6">
        ...
        {/* ── CARRUSEL PRINCIPAL DE 10 IMÁGENES ── */}
        <section className="bg-white rounded-3xl p-4 md:p-6 shadow-sm border border-slate-100 flex flex-col gap-4">
          ...
          <div className="relative bg-slate-900 rounded-2xl overflow-hidden flex items-center justify-center min-h-[340px] md:min-h-[460px]">
            <Swiper
            ...
            >
              {TALLA_SLIDES.map((slide) => (
                <SwiperSlide key={slide.id} className="flex items-center justify-center p-3 md:p-6">
